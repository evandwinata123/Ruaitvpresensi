        ...
        <div class="flex-1 lg:ml-72">
            ...
            <main class="p-4 sm:p-6 lg:p-8">
                <div class="mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-slate-800"><i class="fas fa-user-edit text-indigo-500 mr-2"></i>Edit Karyawan</h1>
                </div>
                @if($errors->any())
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden max-w-3xl">
                    <div class="gradient-header px-6 py-4"><h3 class="text-white font-bold"><i class="fas fa-id-card mr-2"></i>Edit Data: {{ $employee->name }}</h3></div>
                        ...
                        <div class="p-6 space-y-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone" value="{{ old('phone', $employee->phone) }}" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none transition-all">
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea name="address" rows="2" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none transition-all resize-none">{{ old('address', $employee->address) }}</textarea>
                            </div>
